...
class Window(QtGui.QMainWindow):
	...
	def calibrate_publish(self):
		...
		choice = QtGui.QMessageBox.information(self, 'Calibration', "Switch of the ESC and then press OK"
, QtGui.QMessageBox.Ok)
		if choice == QtGui.QMessageBox.Ok:
			self.pub.publish("calibrate")
			choice = QtGui.QMessageBox.information(self, 'Calibration', "Connect the battery now... Wait for the ESC to beep then press OK"
, QtGui.QMessageBox.Ok)
			if choice  == QtGui.QMessageBox.Ok:
				self.pub.publish("calibrate")
				QtGui.QMessageBox.information(self, 'Calibration', "Please Wait a couple of seconds..")
				time.sleep(15)
				QtGui.QMessageBox.information(self, 'Calibration', "Done Calibrating!")
			else:
				pass
		else:
			pass
